      ...
      >
        ...
        <View style={s.acaoList}>
          ...
          <View style={s.acaoRow}>
            <TouchableOpacity style={s.acaoCard} activeOpacity={0.85} onPress={() => navigation.navigate('PropriedadesList')}>
        ...
        <View style={s.sectionRow}>
          ...
          <TouchableOpacity hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }} onPress={() => navigation.navigate('CotacoesList')}>
        ...
        {recentes.length === 0 ? (
          ...
          recentes.map(c => (
            <TouchableOpacity key={c.id} style={s.cotacaoRow} activeOpacity={0.8} onPress={() => navigation.navigate('CotacoesList')}>
